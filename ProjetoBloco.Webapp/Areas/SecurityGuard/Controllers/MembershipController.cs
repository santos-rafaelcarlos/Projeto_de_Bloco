...
using ProjetoBloco.Webapp.Controllers;
using viewModels = ProjetoBloco.Webapp.Areas.SecurityGuard.ViewModels;

namespace ProjetoBloco.Webapp.Areas.SecurityGuard.Controllers
{
